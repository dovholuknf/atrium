...
var WantedHooks = []HookEvent{
	...
	// Record the compaction event and show transient activity. There is no
	// PostCompact hook, so clear the badge on the next activity event or timeout.
	// See store.EventCompacted and daemon.ActivityCompacting.
